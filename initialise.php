<?php
/* Optional first-install forecast capture, PHP 8.0+. Normal five-file operation is unchanged. */
...
*/
out_line('INITIALISE MODE: immediate first forecast capture. Normal recurring start day remains ' . FORECAST_START_DAY . '.', 'warn');
